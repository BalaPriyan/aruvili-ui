...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-300 font-sans selection:bg-zinc-800 flex flex-col">
      <header className="flex h-14 items-center justify-between px-6 w-full max-w-7xl mx-auto border-b border-zinc-900/50 shrink-0">
        ...
        <div className="flex items-center gap-4 text-sm font-medium">
          <Link to="/docs" className="text-zinc-400 hover:text-white transition-colors">Components</Link>
